...
### 🎵 Улучшения Музыкального Плеера
- **Адаптация цветов в темном режиме:** Исправлена проблема с цветом текста в плейлисте в темном режиме для улучшения читаемости
- **Динамические цвета темы:** Названия выбранных песен и имена исполнителей соответствующим образом адаптируются к цветам темы
- **Поддержка интернационализации:** Добавлена многоязычная поддержка для интерфейса плейлиста
- **Улучшения доступности:** Улучшен цветовой контраст и визуальная обратная связь для лучшего пользовательского опыта
