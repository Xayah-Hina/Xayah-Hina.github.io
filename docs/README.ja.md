...
### 🎵 音楽プレーヤー強化
- **ダークモード色適応：** プレイリストのダークモードでのテキスト色の問題を修正し、可読性を向上
- **動的テーマカラー：** 選択された楽曲のタイトルとアーティスト名がテーマカラーに適切に適応
- **国際化サポート：** プレイリストインターフェースに多言語サポートを追加
- **アクセシビリティ向上：** 色のコントラストと視覚的フィードバックを強化し、より良いユーザー体験を提供
...
### 📢 アナウンス機能
- **設定可能なアナウンスバー：** タイトル、コンテンツ、アイコン、タイプ、クローズ可能な機能のオプションを備えたカスタマイズ可能なアナウンスバーを追加しました。
- **柔軟な配置：** アナウンスバーの右下隅にクローズボタンを配置できます。

### 💬 コメントシステム最適化
- **Twikooコメントシステムの表示とパフォーマンスの最適化**
